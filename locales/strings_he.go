...
var dict_he = map[string]string{
	...
	"chatzotNight": "חֲצוֹת הַלַיְלָה",
	"alotHaShachar": "עֲלוֹת הַשַּׁחַר",
	"misheyakir": "משיכיר - זמן ציצית ותפילין",
	"misheyakirMachmir": "משיכיר - זמן ציצית ותפילין",
	"neitzHaChama": "הַנֵץ הַחַמָּה",
	"sofZmanShma": "סוֹף זְמַן קְרִיאַת שְׁמַע גר״א",
	"sofZmanTfilla": "סוֹף זְמַן תְּפִלָּה גר״א",
	"chatzot": "חֲצוֹת הַיּוֹם",
